...
def send_txt_mail():
    ...
    msg['from'] = "vishal-exe@gmail.com"
    msg['to'] = "vishalyadav831874@gmail.com"
    msg.set_content(" Location Alert..! We've detected your face in Tokyo. Kindly cross verify with your img")
    
    with smtplib.SMTP_SSL('smtp.gmail.com', 465) as server:
        server = smtplib.SMTP_SSL('smtp.gmail.com', 465)
        server.login("heytest98@gmail.com", "MYtest@124")
        server.send_message(msg)
    print("Succes...!")
    
def send_img_mail():
    From = "Face_Detector_Machine Created By me...!!"
    Reciever_Email = "vishalyadav831874@gmail.com"
...
while True:
    ...
    try:
        ...
        if confidence >= 90:
            cv2.putText(image, "Hey Vishal", (250, 450), cv2.FONT_HERSHEY_COMPLEX, 1, (0,255,0), 2)
